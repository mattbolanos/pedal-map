...
import { useComposedRefs } from "#/lib/ui/compose-refs";
...
function SpeedDialTrigger(props: SpeedDialTriggerProps) {
  ...
  return (
    <Button
      ...
      {...triggerProps}
      ref={composedRef}
      className={cn("group/speed-dial-trigger size-11 rounded-full", className)}
      onClick={onClick}
...
function SpeedDialContent(props: SpeedDialContentProps) {
  ...
  }, [align, triggerRef, open, side, offset]);
    ...
    props: mergeProps<"div">(
      {
        ...
        ref: composedRef,
        className: cn(speedDialContentVariants({ side, align, className })),
        style: contentStyle,
        onMouseEnter,
        onMouseLeave,
...
function SpeedDialAction(props: SpeedDialActionProps) {
  ...
  return (
    <Button
      ...
      {...actionProps}
      className={cn(
        "bg-accent size-11 shrink-0 rounded-full shadow-md",
        className,
      )}
      onClick={onClick}
    />
    ...
    props: mergeProps<"div">(
      {
        id: labelId,
        className: cn(
          "pointer-events-none whitespace-nowrap rounded-md bg-popover px-2 py-1 text-popover-foreground text-sm border shadow-md",
          className,
        ),
      },
      props,
