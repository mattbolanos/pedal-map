...
import { getNeighborhoodBucketMeta } from "#/lib/neighborhoods";
import { availabilityColorCss } from "#/lib/station-pin";
import { cn, getRelativeTime } from "#/lib/utils";
import { Badge, type NeighborhoodBadgeVariant } from "./ui/badge";
  ...
  <Card className="bg-popover md:w-72">
    <CardHeader className="gap-1.5">
      ...
      <div className="flex items-center gap-2">
        <Badge
          variant={station.neighborhoodBucket as NeighborhoodBadgeVariant}
